    ...
    <div class="col-md-4 mb-4">
        <div class="card border-0 shadow-sm h-100 card-menu">
            <div class="card-body text-center py-5">
                ...
                <p class="card-text text-muted small">Lihat jadwal kelas dan absensi mahasiswa.</p>
                <a href="#" class="btn btn-outline-info btn-sm rounded-pill px-4 disabled">Lihat Jadwal</a>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-4 mb-4">
        <div class="card border-0 shadow-sm h-100 card-menu">
            <div class="card-body text-center py-5">
                ...
                <a href="#" class="btn btn-outline-secondary btn-sm rounded-pill px-4 disabled">Cek Bimbingan</a>
            </div>
        </div>
    </div>
</div>